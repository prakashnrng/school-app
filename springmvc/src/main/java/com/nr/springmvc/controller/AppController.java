...
public class AppController {
	...
	public String listUsers(ModelMap model) {
	 ...
	 /*@RequestMapping(value={"/","/list"},method=RequestMethod.GET)
	 public ResponseEntity<?> listusernrp(ModelMap model){
 ...
 logger.info("AppController->loginPage()");
		if (isCurrentAuthenticationAnonymous()) {
			System.out.println("AppCOntroller->loginPage()->Authenticated()");
			return "LOGINDEF";
	    } else {
	    	System.out.println("AppCOntroller->loginPage()->not Authenticated()");
	    	return "redirect:/list";  
	    }
	}
	...
	public String dashboardform(){
		logger.info("AppController->dashboardform()");
		return "dashboard";
		/*if(isCurrentAuthenticationAnonymous()){
			return "dashboard";
		}else{
