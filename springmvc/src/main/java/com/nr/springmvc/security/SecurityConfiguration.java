...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobalSecurity(AuthenticationManagerBuilder auth) throws Exception {
    	logger.info("SecurityConfiguration->configureGlobalSecurity(auth)");
    ...
    public PasswordEncoder passwordEncoder() {
    	logger.info("SecurityConfiguration->passwordEncoder()");
    ...
    public PersistentTokenBasedRememberMeServices getPersistentTokenBasedRememberMeServices() {
    	System.out.println("SecurityConfiguration->getPersistentTokenBasedRememberMeServices()");
    ...
    public AuthenticationTrustResolver getAuthenticationTrustResolver() {
    	System.out.println("SecurityConfiguration->AuthenticationTrustResolver()");
